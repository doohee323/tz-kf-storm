...
import tzkfstorm.case4.bolt.BoltBuilder;
import tzkfstorm.case4.bolt.CountBolt;
import tzkfstorm.case4.bolt.ReportBolt;
import tzkfstorm.case4.bolt.SolrBolt;
import tzkfstorm.case4.bolt.SplitLogBolt;
import tzkfstorm.case4.spout.SpoutBuilder;
...
public class Topology {
	...
	public Topology(String configFile) throws Exception {
		...
		try {
			configs.load(Topology.class.getResourceAsStream("/case4.properties"));
