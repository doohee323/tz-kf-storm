...
import tzkfstorm.case7.bolt.BoltBuilder;
import tzkfstorm.case7.bolt.EsperBolt;
import tzkfstorm.case7.bolt.SolrBolt;
import tzkfstorm.case7.spout.SpoutBuilder;
...
public class Topology {
	...
	public Topology(String configFile) throws Exception {
		...
		try {
			configs.load(Topology.class.getResourceAsStream("/case7.properties"));
