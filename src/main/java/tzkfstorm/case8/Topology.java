...
import tzkfstorm.case8.bolt.BoltBuilder;
import tzkfstorm.case8.bolt.EsperBolt;
import tzkfstorm.case8.bolt.SolrBolt;
import tzkfstorm.case8.spout.SpoutBuilder;
...
public class Topology {
	...
	public Topology(String configFile) throws Exception {
		...
		try {
			configs.load(Topology.class.getResourceAsStream("/case8.properties"));
